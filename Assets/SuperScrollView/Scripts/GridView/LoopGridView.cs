...
namespace SuperScrollView
{
    ...
    public class LoopGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public void SetOnSnapItemFinished(System.Action<LoopGridView, LoopGridViewItem> callback)
        {
            mOnSnapItemFinished = callback;
        }
        
        public void SetOnSnapNearestChanged(System.Action<LoopGridView> callback)
        {
            mOnSnapNearestChanged = callback;
        }

        public System.Func<LoopGridView,int,int,int, LoopGridViewItem> OnGetItemByRowColumn
        {
            set => mOnGetItemByRowColumn = value;
        }
        ...
        */
            ...
            LoopGridViewInitParam initParam = null)
        {
            ...
            {
                //如果已经初始化过了,没有必要再走一次,所有很多时候都是定义在awake、init的地方,但是对于lua这个就有问题了
